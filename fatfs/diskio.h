...
// at the same time.
typedef DRESULT (*DiskReadFunc)(BYTE pdrv, BYTE* buff, LBA_t sector, UINT count);
typedef DRESULT (*DiskWriteFunc)(BYTE pdrv, const BYTE* buff, LBA_t sector, UINT count);
